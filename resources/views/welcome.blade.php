...
<body class="antialiased">
    <div class="bg-white">
        ...
        <main>
            <!-- Hero section -->
            <div class="relative pb-16 overflow-hidden bg-gray-900 isolate pt-14 sm:pb-20">
            ...
            <!-- Pricing section -->
            <div class="relative px-6 mt-32 bg-white isolate sm:mt-56 lg:px-8">
                ...
                <p class="max-w-2xl mx-auto mt-6 text-lg leading-8 text-center text-gray-600">Qui iusto aut est earum
                ...
                <div
                    ...
                    <div
                        class="p-8 rounded-3xl ring-1 ring-gray-900/10 sm:p-10 bg-white/60 sm:mx-8 lg:mx-0 rounded-t-3xl sm:rounded-b-none lg:rounded-tr-none lg:rounded-bl-3xl">
            ...
            <div class="px-6 mx-auto mt-32 max-w-7xl sm:mt-56 lg:px-8">
                <div class="max-w-4xl mx-auto divide-y divide-gray-900/10">
                  ...
                  -->
                                        <svg class="hidden w-6 h-6" fill="none" viewBox="0 0 24 24"
